...
public class Pasajero  implements java.io.Serializable {
    ...
    public Pasajero(String pnombre, String papp, String papm, String pcorreo, String pnoCuenta, Date pfechaNac, String pcontrasenia) {
    ...
    public Pasajero(String pnombre, String papp, String papm, String pcorreo, String pnoCuenta, Date pfechaNac, String pcontrasenia, Set pasajeroRutas, Set perfilPasajeros) {
       this.pnombre = pnombre;
       this.papp = papp;
       this.papm = papm;
       this.pcorreo = pcorreo;
